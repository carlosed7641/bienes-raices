    ...
    if (empty($errores)) {
        ...
        // SUBIDA DE ARCHIVOS 
        //Crear carpeta
        $carpetaImagenes = '../../../vista/imagenes/';
        ...
        if ($resultado) {
            ...
            header('Location: /bienesraices/controlador/admin?resultado=1');
        }
...
<main class="contenedor seccion">
    ...
    <a href="/bienesraices/controlador/admin/" class="boton boton-verde">Volver</a>
    ...
    <form class="formulario" method="POST" action="/bienesraices/controlador/admin/propiedades/crear.php" enctype="multipart/form-data">
        <fieldset>
